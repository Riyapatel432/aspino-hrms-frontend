...
/**
 * Parses normal permission strings (e.g. "create-user", "update-user", "read-employee")
...
export function RolesManagerContent() {
  ...
  // Group permissions directly by subject (e.g. user, employee, attendance, role)
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="text-xs text-slate-500 dark:text-slate-400 mt-1 max-w-2xl">
                Configure roles and map permissions (e.g. <code className="font-mono text-aspino-primary font-bold">create-user</code>, <code className="font-mono text-aspino-primary font-bold">update-user</code>, <code className="font-mono text-aspino-primary font-bold">read-employee</code>).
              </p>
            </div>
          </div>
      ...
      {activeTab === "matrix" ? (
        ...
        <div className="rounded-2xl border border-slate-200/80 dark:border-slate-800 bg-white dark:bg-slate-900 p-6 shadow-xs space-y-4">
          ...
          <DataTable
            ...
            data={allPermissions}
            searchable={true}
            searchPlaceholder="Search permission codes like create-user, read-employee..."
            pageSize={10}
        ...
        <DialogContent className="sm:max-w-md p-0 overflow-hidden border border-border/50 shadow-2xl rounded-3xl bg-card">
          ...
          >
            ...
            <div className="space-y-1.5">
              ...
              <Input
                id="role-name-input"
                placeholder="e.g. HR Manager, Supervisor, Executive"
                value={roleNameInput}
